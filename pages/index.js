  ...
  return (
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-10 pt-6 pb-8">
          <div className="mx-auto flex w-full flex-col gap-5 text-center xl:w-1/2">
            <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
              Michael Ignacio
            </h1>
            <p className="text-black dark:text-white sm:pr-6 sm:text-lg sm:leading-8">
              Welcome to my online portfolio - I am a front-end engineer by trade who loves building
              beautiful interfaces for web and mobile.
            </p>
          </div>
